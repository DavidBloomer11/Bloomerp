...
class ExecuteSqlView(APIView):
    ...
    def post(self, request: HttpRequest) -> JsonResponse:
        ...
        page = self._parse_positive_int(payload.get("page") or payload.get("sql_page"), default=1)
        page_size = self._parse_positive_int(payload.get("page_size") or payload.get("sql_page_size"), default=25)
