...
FIELD_TYPE_TEMPLATE_INJECTIONS = {
    FIELD_TYPE_REGISTRY.PROPERTY.id: [VALUE],
    FIELD_TYPE_REGISTRY.CHAR_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.CHOICE_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.TEXT_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.EMAIL_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.URL_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.PHONE_NUMBER_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.SLUG_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.INTEGER_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.FLOAT_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.DECIMAL_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.POSITIVE_INTEGER_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.POSITIVE_SMALL_INTEGER_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.BIG_INTEGER_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.SMALL_INTEGER_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.BOOLEAN_FIELD.id: [VALUE, YES_NO],
    FIELD_TYPE_REGISTRY.NULL_BOOLEAN_FIELD.id: [VALUE, YES_NO],
    FIELD_TYPE_REGISTRY.DATE_FIELD.id: [VALUE, FORMATTED_DATE],
    FIELD_TYPE_REGISTRY.DATE_TIME_FIELD.id: [VALUE, FORMATTED_DATE],
    FIELD_TYPE_REGISTRY.TIME_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.DURATION_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.FILE_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.IMAGE_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.FOREIGN_KEY.id: [VALUE, NESTED_FIELD],
    FIELD_TYPE_REGISTRY.ONE_TO_ONE_FIELD.id: [VALUE, NESTED_FIELD],
    FIELD_TYPE_REGISTRY.MANY_TO_MANY_FIELD.id: [LIST, TABLE, COUNT],
    FIELD_TYPE_REGISTRY.ONE_TO_MANY_FIELD.id: [LOOP, TABLE, COUNT],
    FIELD_TYPE_REGISTRY.USER_FIELD.id: [VALUE, NESTED_FIELD],
    FIELD_TYPE_REGISTRY.UUID_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.STATUS_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.ICON_FIELD.id: [VALUE],
    FIELD_TYPE_REGISTRY.BLOOMERP_FILE_FIELD.id: [VALUE],
}
